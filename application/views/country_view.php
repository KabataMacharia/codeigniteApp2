                                ...
                                <div class="portlet portlet-default">
                                    ...
                                    <div id="basicFormExample" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                             <?php echo form_open('admin/addcountry', 'id="form"  data-parsley-validate');?>
												...
												<div class="form-group">
                                                  ...
                                                  <input type="text" name="name" id="name" required data-parsley-error-message="<font color='red'>Please enter Country Name</font>" class="form-control">
                                                </div>
                                                <div class="form-group">
...
var formdata = $('#form').serializeArray();
			...
			$.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/admin/addcountry",
            data: formdata,
