                                ...
                                <div class="portlet portlet-default">
                                    ...
                                    <div id="basicFormExample" class="panel-collapse collapse in">
                                        <div class="portlet-body">
                                             <?php echo form_open('admin/updateCountry', 'id="form"  data-parsley-validate');?>
                                                <div hidden class="alert alert-success" id='load'>
												 </div>
												  <div hidden class="alert alert-danger" id='load1'>
												 </div>
												 <?php if($country==""){?>
													<p style="color:red"><?php echo "The country record does not exists"; ?></p>
											     <?php } ?>
												<div class="form-group">
                                                  <label>Country Name</label>
												  	<input type="hidden" class="form-control" id="id" name="id" 
													value=" <?php if($country!=""){ echo $country->id; } ?>">
                                                  <input type="text" name="name" id="name" required data-parsley-error-message="<font color='red'>Please enter Country Name</font>" class="form-control"  value=" <?php if($country!=""){ echo $country->name; } ?>">
                                                </div>
                                                <div class="form-group">
                                                 <label>Country Code</label>
                                                 <input type="text" name="code" id="code" required data-parsley-type="integer" data-parsley-error-message="<font color='red'>Please enter country code</font>" class="form-control" value=" <?php if($country!=""){ echo $country->code; } ?>">
                                                </div>
...
var formdata = $('#form').serializeArray();
			...
			$.ajax({
            type: "POST",
            url: "<?php echo base_url(); ?>" + "index.php/admin/updateCountry",
            data: formdata,
		   ...
		   if(data=='1'){
			...
			$("#load").html("Country Edited Successfuly.").show();
